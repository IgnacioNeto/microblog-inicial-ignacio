...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Ago-2022 às 16:24
...
--
-- Banco de dados: `microblog_ignacio`
--
...
CREATE TABLE `noticias` (
  ...
  `categoria_id` smallint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'Valéria', 'val@gmail', '$2y$10$9NdMqal/loTHu2x6/WvEBO2Ztyil7omSu8uBt9YDvijHY0ELvWW5W', 'editor'),
(8, 'Ignacio A. da Cunha Neto', 'igcunha89@gmail.com', '$2y$10$FF.xJE1Bf/3liWtNRvR.buhUJ/p9ulRIHJCmtC2VyLlSq2Oevu6ym', 'admin'),
(9, 'teste', 'teste@teste.com', '$2a$12$WfK9/hAKYK3SyE4WukUu8eAk9/Ou1OXM5/p53u0R7znpwDqoz3koO', 'admin');
